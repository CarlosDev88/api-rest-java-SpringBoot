...
public class LibroRestController {
	...
	public ResponseEntity<LibroResponseRest> crear(@RequestBody Libro request) {// esto indica que por el cuerpo de la
																				// peticion va a benir un objeto
		ResponseEntity<LibroResponseRest> response = service.crear(request);
		return response;
	}

	@PutMapping("/libros/actualizar/{id}")
	...
	public ResponseEntity<LibroResponseRest> borrar(@PathVariable Long id) {
