...
public class CategoriaRestController {
	...
	public ResponseEntity<CategoriaResponseRest> crear(@RequestBody  Categoria request) {//esto indica que por el cuerpo de la peticion va a benir un objeto
	...
	@DeleteMapping("/categorias/borrar/{id}")
	public ResponseEntity<CategoriaResponseRest> borrar(@PathVariable Long id){
